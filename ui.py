...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioBlockDetection = QtGui.QRadioButton(self.centralwidget)
        self.radioBlockDetection.setObjectName(_fromUtf8("radioBlockDetection"))
        self.horizontalLayout_2.addWidget(self.radioBlockDetection)
        ...
        self.btn_pick_sort = QtGui.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btn_pick_sort.setFont(font)
        self.btn_pick_sort.setObjectName(_fromUtf8("btn_pick_sort"))
        self.verticalLayout_11.addWidget(self.btn_pick_sort)
        self.btn_pick_stack = QtGui.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btn_pick_stack.setFont(font)
        self.btn_pick_stack.setObjectName(_fromUtf8("btn_pick_stack"))
        self.verticalLayout_11.addWidget(self.btn_pick_stack)
        self.btn_line_up = QtGui.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btn_line_up.setFont(font)
        self.btn_line_up.setObjectName(_fromUtf8("btn_line_up"))
        self.verticalLayout_11.addWidget(self.btn_line_up)
        self.btn_stack_colors = QtGui.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btn_stack_colors.setFont(font)
        self.btn_stack_colors.setObjectName(_fromUtf8("btn_stack_colors"))
        self.verticalLayout_11.addWidget(self.btn_stack_colors)
        self.btn_stack_high = QtGui.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btn_stack_high.setFont(font)
        self.btn_stack_high.setObjectName(_fromUtf8("btn_stack_high"))
        self.verticalLayout_11.addWidget(self.btn_stack_high)
        ...
        self.sldrHlow.setOrientation(QtCore.Qt.Horizontal)
        self.sldrHlow.setObjectName(_fromUtf8("sldrHlow"))
        self.verticalLayout_11.addWidget(self.sldrHlow)
        self.rdoutHlow = QtGui.QLabel(self.SliderFrame)
        self.rdoutHlow.setMinimumSize(QtCore.QSize(30, 0))
        self.rdoutHlow.setObjectName(_fromUtf8("rdoutHlow"))
        self.verticalLayout_11.addWidget(self.rdoutHlow)

        self.sldrHhigh = QtGui.QSlider(self.SliderFrame)
        self.sldrHhigh.setMinimum(0)
        self.sldrHhigh.setMaximum(180)
        self.sldrHhigh.setOrientation(QtCore.Qt.Horizontal)
        self.sldrHhigh.setObjectName(_fromUtf8("sldrHhigh"))
        self.verticalLayout_11.addWidget(self.sldrHhigh)
        self.rdoutHhigh = QtGui.QLabel(self.SliderFrame)
        self.rdoutHhigh.setMinimumSize(QtCore.QSize(30, 0))
        self.rdoutHhigh.setObjectName(_fromUtf8("rdoutHhigh"))
        self.verticalLayout_11.addWidget(self.rdoutHhigh)

        self.sldrSlow = QtGui.QSlider(self.SliderFrame)
        self.sldrSlow.setMinimum(0)
        self.sldrSlow.setMaximum(255)
        self.sldrSlow.setOrientation(QtCore.Qt.Horizontal)
        self.sldrSlow.setObjectName(_fromUtf8("sldrSlow"))
        self.verticalLayout_11.addWidget(self.sldrSlow)
        self.rdoutSlow = QtGui.QLabel(self.SliderFrame)
        self.rdoutSlow.setMinimumSize(QtCore.QSize(30, 0))
        self.rdoutSlow.setObjectName(_fromUtf8("rdoutSlow"))
        self.verticalLayout_11.addWidget(self.rdoutSlow)

        self.sldrShigh = QtGui.QSlider(self.SliderFrame)
        self.sldrShigh.setMinimum(0)
        self.sldrShigh.setMaximum(255)
        self.sldrShigh.setOrientation(QtCore.Qt.Horizontal)
        self.sldrShigh.setObjectName(_fromUtf8("sldrShigh"))
        self.verticalLayout_11.addWidget(self.sldrShigh)
        self.rdoutShigh = QtGui.QLabel(self.SliderFrame)
        self.rdoutShigh.setMinimumSize(QtCore.QSize(30, 0))
        self.rdoutShigh.setObjectName(_fromUtf8("rdoutShigh"))
        self.verticalLayout_11.addWidget(self.rdoutShigh)

        self.sldrVlow = QtGui.QSlider(self.SliderFrame)
        self.sldrVlow.setMinimum(0)
        self.sldrVlow.setMaximum(255)
        self.sldrVlow.setOrientation(QtCore.Qt.Horizontal)
        self.sldrVlow.setObjectName(_fromUtf8("sldrVlow"))
        self.verticalLayout_11.addWidget(self.sldrVlow)
        self.rdoutVlow = QtGui.QLabel(self.SliderFrame)
        self.rdoutVlow.setMinimumSize(QtCore.QSize(30, 0))
        self.rdoutVlow.setObjectName(_fromUtf8("rdoutVlow"))
        self.verticalLayout_11.addWidget(self.rdoutVlow)

        self.sldrVhigh = QtGui.QSlider(self.SliderFrame)
        self.sldrVhigh.setMinimum(0)
        self.sldrVhigh.setMaximum(255)
        self.sldrVhigh.setOrientation(QtCore.Qt.Horizontal)
        self.sldrVhigh.setObjectName(_fromUtf8("sldrVhigh"))
        self.verticalLayout_11.addWidget(self.sldrVhigh)
        self.rdoutVhigh = QtGui.QLabel(self.SliderFrame)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioBlockDetection.setText(_translate("MainWindow", "Block Detection", None))
        ...
        self.btn_pick_sort.setText(_translate("MainWindow", "Pick n Sort", None))
        self.btn_pick_stack.setText(_translate("MainWindow", "Pick n Stack", None))
        self.btn_line_up.setText(_translate("MainWindow", "Line em up", None))
        self.btn_stack_colors.setText(_translate("MainWindow", "Stack by color", None))
        self.btn_stack_high.setText(_translate("MainWindow", "Stack high", None))
